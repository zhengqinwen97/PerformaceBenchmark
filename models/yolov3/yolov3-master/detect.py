...
from yolov3_models.common import DetectMultiBackend
...
def run(weights=ROOT / 'yolov3.pt',  # model.pt path(s)
        ...
        update=False,  # update all yolov3_models
...
def parse_opt():
    ...
    parser.add_argument('--update', action='store_true', help='update all yolov3_models')
