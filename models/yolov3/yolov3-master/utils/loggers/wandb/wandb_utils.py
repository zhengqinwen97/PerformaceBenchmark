...
class WandbLogger():
    """Log training runs, datasets, yolov3_models, and predictions to Weights & Biases.
    ...
    yolov3_models and predictions can also be logged.
    ...
    def setup_training(self, opt):
        """
        Setup the necessary processes for training YOLO yolov3_models:
