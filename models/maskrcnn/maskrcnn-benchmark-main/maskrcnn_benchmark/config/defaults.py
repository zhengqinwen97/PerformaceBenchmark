...
# Convert image to BGR format (for Caffe2 yolov3_models), in range 0-255
...
# Use True only for the original MSRA ResNet; use False for C2 and Torch yolov3_models
